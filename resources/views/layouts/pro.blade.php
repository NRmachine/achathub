...
<header class="pro-header sticky-top">
    <div class="container-fluid px-3 px-lg-4 py-2">
        <div class="d-flex align-items-center gap-3">
            <a class="pro-brand" href="{{ route('pro.index') }}"><img src="{{ asset('assets/achathub-logo.webp') }}?v=20260803b" width="38" height="34" alt=""><span>AchatHub <strong>PRO</strong></span></a>
